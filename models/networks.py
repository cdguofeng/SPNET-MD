...
from models.My_Model6 import SPNet_MD
###############################################################################
# Functions
###############################################################################
...
def get_generator(model_config):
    ...
    elif generator_name == 'SPNet_MD':
        model_g = SPNet_MD(img_channel=3, width=32, middle_blk_num=2,
                         enc_blk_nums=[1, 1, 1, 20], dec_blk_nums=[2, 2, 2, 2])
