...
class Trainer:
    ...
    def train(self):
        ...
        for epoch in range(0, self.config['num_epochs']):
            ...
            if self.metric_counter.update_best_model():
                ...
                }, 'best_2023-2-22.h5'.format(self.config['experiment_desc']))
            torch.save({
                'model': self.netG.state_dict()
            }, 'last_2023-2-22.h5'.format(self.config['experiment_desc']))
    ...
    def _init_params(self):
        ...
        # flops1, params1 = get_model_complexity_info(self.netG, (3, 256, 256), as_strings=True, print_per_layer_stat=True)
        #
